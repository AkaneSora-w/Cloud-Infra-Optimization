...
| <a name="module_ec2_acme"></a> [ec2\_acme](#module\_ec2\_acme) | terraform-aws-modules/ec2-instance/aws | ~> 5.6.1 |
| <a name="module_ec2_acme_clone"></a> [ec2\_acme\_clone](#module\_ec2\_acme\_clone) | terraform-aws-modules/ec2-instance/aws | ~> 5.6.1 |
...
| <a name="module_sg_acme"></a> [sg\_acme](#module\_sg\_acme) | terraform-aws-modules/security-group/aws | ~> 5.1.2 |

## Resources

| Name | Type |
|------|------|
| [aws_ebs_volume.extra_acme_clone_ebs](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/ebs_volume) | resource |
| [aws_ebs_volume.extra_acme_ebs](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/ebs_volume) | resource |
...
| [aws_lb_listener_rule.backoffice_acme_rule](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/lb_listener_rule) | resource |
| [aws_lb_listener_rule.collaudo_acme_rule](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/lb_listener_rule) | resource |
| [aws_lb_listener_rule.connector_api_2_acme_rule](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/lb_listener_rule) | resource |
| [aws_lb_listener_rule.formazione_acme_rule](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/lb_listener_rule) | resource |
| [aws_lb_listener_rule.acme_rule](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/lb_listener_rule) | resource |
| [aws_lb_listener_rule.jakala_acme_rule](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/lb_listener_rule) | resource |
| [aws_lb_listener_rule.zefiro_acme_rule](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/lb_listener_rule) | resource |
| [aws_lb_target_group.acme](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/lb_target_group) | resource |
| [aws_lb_target_group_attachment.ec2_acme](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/lb_target_group_attachment) | resource |
| [aws_lb_target_group_attachment.ec2_acme_clone](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/lb_target_group_attachment) | resource |
...
| [aws_volume_attachment.extra_ebs_acme_attach](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/volume_attachment) | resource |
| [aws_volume_attachment.extra_ebs_acme_clone_attach](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/volume_attachment) | resource |
...
|------|-------------|------|---------|:--------:|
| <a name="input_backup_tag"></a> [backup\_tag](#input\_backup\_tag) | Bakcup tag to switch on/off resources | <pre>object({<br>    acme       = string<br>    acme_clone = string<br>    ftp        = string<br>  })</pre> | <pre>{<br>  "ftp": null,<br>  "acme": null,<br>  "acme_clone": null<br>}</pre> | no |
...
| <a name="input_ec2_acme_config"></a> [ec2\_acme\_config](#input\_ec2\_acme\_config) | ##################################### EC2 ##################################### | <pre>map(object({<br>    create        = bool<br>    ami           = string<br>    instance_type = string<br>    volume_size   = number<br>    key_name      = string<br>    subnet_id     = string<br>    extra_ebs = optional(map(object({<br>      size = number<br>    })), {})<br>  }))</pre> | n/a | yes |
| <a name="input_environment"></a> [environment](#input\_environment) | n/a | `string` | n/a | yes |
| <a name="input_acme_tg_cfg"></a> [acme\_tg\_cfg](#input\_acme\_tg\_cfg) | n/a | <pre>object({<br>    port                        = string<br>    health_check_path           = string<br>    domain_names                = list(string)<br>    collaudo_domain_names       = list(string)<br>    formazione_domain_names     = optional(list(string), [])<br>    backoffice_domain_names     = optional(list(string), [])<br>    zefiro_domain_names         = optional(list(string), [])<br>    jakala_domain_names         = optional(list(string), [])<br>    connector_api2_domain_names = optional(list(string), [])<br>  })</pre> | n/a | yes |
...
| <a name="input_schedule_tag"></a> [schedule\_tag](#input\_schedule\_tag) | Schedule tag to switch on/off resources | <pre>object({<br>    ec2_acme       = string<br>    ec2_acme_clone = string<br>    rds            = string<br>  })</pre> | n/a | yes |
