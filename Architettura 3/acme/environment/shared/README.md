...
| <a name="input_acme_tg_cfg"></a> [acme\_tg\_cfg](#input\_acme\_tg\_cfg) | n/a | <pre>object({<br>    port                        = string<br>    health_check_path           = string<br>    domain_names                = list(string)<br>    collaudo_domain_names       = list(string)<br>    zefiro_domain_names         = optional(list(string), [])<br>    jakala_domain_names         = optional(list(string), [])<br>    connector_api2_domain_names = optional(list(string), [])<br>  })</pre> | n/a | yes |
